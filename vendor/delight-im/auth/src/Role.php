...
final class Role {
	...
	const PROOFREADER = 1;
	const PROOFING_SUPERVISOR = 2;
	const IMAGE_EDITOR = 4;
	const LAYOUT_EDITOR = 8;
	const LAYOUT_SUPERVISOR = 16;
	const BLURB_WRITER = 32;
	const BLURB_EDITOR = 64;
	const COVER_ARTIST = 128;
	const COORDINATOR = 256;
